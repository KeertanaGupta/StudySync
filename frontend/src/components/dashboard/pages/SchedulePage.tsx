...
import { getSessions, createSession, getGroups, getOptimalSlots, updateAvailability, getAvailability, uploadTimetableOcr } from '../../../services/sessionApi';
...
export const SchedulePage = ({ onJoinSession }: SchedulePageProps) => {
  ...
  const fetchEvents = async () => {
    try {
      ...
      setEvents([...mappedSessions, ...mappedAvail]);
    } catch (err) {
